    ...
    <div class="collapse navbar-collapse navbar-right" id="menu">
      <ul class="nav navbar-nav">
        <li class="<?= (esOpcionMenuActiva("index") ? "active" : ""); ?> lien">
          <a href="<?= (esOpcionMenuActiva("index") ? "#" : "/"); ?>"><i class="fa fa-home sr-icons"></i>
            Home</a>
        </li>
        ...
        <?php else : ?>
          ...
          <li class="<?= (esOpcionMenuActiva("logout") ? "active" : ""); ?>">
            <a href="<?= (esOpcionMenuActiva("logout") ? "#" : "/logout.php"); ?>"><i class="fa fa-hand-o-right sr-icons"></i> Logout</a>
          </li>
        <?php endif ?>
      </ul>
    </div>
